    ...
    public partial class CreateDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersQualifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersQualifications_Qualifications_QualificationId",
                        column: x => x.QualificationId,
                        principalTable: "Qualifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersQualifications_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersQualifications_QualificationId",
                table: "UsersQualifications",
                column: "QualificationId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersQualifications_UserId",
                table: "UsersQualifications",
                column: "UserId");
        }
